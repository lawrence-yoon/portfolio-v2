...
export default function page() {
  return (
    <div>
      ...
      >
        <p>
          Do you need a new keyboard? Has the so called algorithm sent you down
          a mechanical keyboard rabbit hole? Perhaps you are already familiar
          with the mechanical keyboard niche terms, such as cherry, gaterons,
          kailh chocs, holy pandas, and are itching for your next mechanical
          keyboard? Has the machine god beckoned, demanding you to interface
          with your tech using only the finest devices? If you&apos;ve answered
          yes to any of the above, you&apos;ve come to the right place.
        </p>
